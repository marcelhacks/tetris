...
url=f"https://raw.githubusercontent.com/{repo}/{branch}/.relay-coordination/{run_id}/smb-attacker.json"
last={}
for attempt in range(600):
    try:
        response=requests.get(url,headers={"User-Agent":"firefox-smb-relay-lab"},
...
raise SystemExit("SMB attacker coordination was not published")
